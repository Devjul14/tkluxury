    ...
    <div class="container">
        <div class="footer_main d-sm-flex flex-wrap flex-lg-nowrap justify-content-between">
            ...
            <div class="footer_main-block footer_main-block--contacts col-sm-5 col-lg-auto">
                ...
                <ul class="footer_main-block_contacts">
                    <li class="list-item d-flex">
                        ...
                        <p class="wrapper">
                            <span class="linebreak">{{ config('contact.address.line1', '54826 Fadel Circles') }}</span>
                            <span class="linebreak">{{ config('contact.address.line2', 'Darrylstad, AZ 90995') }}</span>
                        </p>
                    </li>
                    <li class="list-item d-flex">
            ...
            <div class="footer_main-block footer_main-block--follow col-sm-5 col-lg-auto d-flex flex-column">
                ...
                <p class="footer_main-block_text">{{ config('social.description', 'Venenatis urna cursus eget nunc scelerisque') }}</p>
    ...
    <div class="footer_copyright">
        <div class="container">
            <p class="footer_copyright-text">
                <span class="linebreak">{{ config('app.name', 'Hosteller') }} &copy; {{ date('Y') }}</span>
