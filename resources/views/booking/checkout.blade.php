...
<style>
    ...
    .checkout.section {
        ...
        /* Warna latar belakang yang lembut, seperti body Bootstrap */
    }

    .checkout_main {
        gap: 30px;
        /* Jarak antara konten utama dan sidebar di layout d-lg-flex */
    }
    ...
    .checkout_main-content {
        ...
        /* Sudut membulat standar Bootstrap */
    ...
    .checkout_main-content_form-section {
        margin-bottom: 40px;
        /* Jarak antar bagian form */
    }

    .checkout_main-content_form-section:last-child {
        margin-bottom: 0;
        /* Hapus margin bawah untuk section terakhir */
    }
    ...
    .form-group_field {
        ...
        /* Padding seperti form-control Bootstrap */
        font-size: 1rem;
        font-weight: 400;
        line-height: 1.5;
        color: #212529;
    ...
    .checkbox_label a {
        color: #0d6efd;
        /* Warna link primary Bootstrap */
        text-decoration: none;
    }

    .checkbox_label a:hover {
        color: #0a58ca;
        /* Warna link hover Bootstrap */
    ...
    .checkout_main-sidebar {
        width: 380px;
        /* Lebar fixed untuk sidebar, bisa disesuaikan */
        flex-shrink: 0;
        /* Mencegah sidebar mengecil */
    }

    @media (max-width: 991.98px) {
        .checkout_main-sidebar {
            width: 100%;
            /* Full width di bawah breakpoint lg */
            margin-top: 30px;
            /* Jarak atas jika layout menjadi stack */
        }
    }
    ...
    .checkout_main-sidebar_summary {
        ...
        padding: 30px;
        position: sticky;
        /* Agar sidebar tetap saat scroll */
        top: 30px;
    ...
    .checkout_main-sidebar_summary_pricing_item--total {
        ...
        font-weight: 700;
        color: #212529;
        /* Warna teks lebih gelap untuk total */
    }

    .checkout_main-sidebar_summary_pricing_item--total .value {
        color: #0d6efd;
        /* Warna primary untuk total harga */
        font-size: 1.4rem;
    }
    ...
    .checkout_main-sidebar_summary_submit:hover {
        ...
        /* Warna primary darker pada hover */
        border-color: #0a58ca;
    }
    ...
    @media (max-width: 767.98px) {
        ...
        .checkout_main-content_form-section_title {
            font-size: 1.4rem;
            /* Sesuaikan ukuran judul di layar kecil */
        }
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea
                                            ...
                                            id="address"
                                            name="address"
                                            rows="3">{{ old('address', $booking->student->address ?? '') }}</textarea>
                                        @error('address')
                                        <span class="form-group_error">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="checkout_main-content_form-section_content">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        placeholder="Any special requests or preferences...">{{ old('special_requests', $booking->special_requests ?? '') }}</textarea>
                    ...
                    <div class="checkout_main-sidebar_summary" data-aos="fade-left">
                        ...
                        <div class="checkout_main-sidebar_summary_pricing">
                            <div class="checkout_main-sidebar_summary_pricing_item">
                                ...
                                @if($booking->room)
                                <span class="value">{{ Number::currency($booking->room->price_per_month, env('APP_DEFAULT_CURRENCY', 'USD')) }}</span>
                                @endif
                                @if($booking->property)
