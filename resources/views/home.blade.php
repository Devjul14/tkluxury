            ...
            <div class="promo_info">
                ...
                <ul class="info_list">
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up">
                        ...
                        <div class="main">
                            <h4 class="main_title">Online reservation</h4>
                            <p class="main_text">Browse available student accommodations on our platform.</p>
                        </div>
                    </li>
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up" data-aos-delay="50">
                        ...
                        <div class="main">
                            <h4 class="main_title">Documents and payment</h4>
                            <p class="main_text">Fill in your personal data and secure your booking by payment.</p>
                        </div>
                    </li>
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="main">
                            <h4 class="main_title">Contract Approval</h4>
                            <p class="main_text">Once payment is successful, a rental agreement will be sent to your email.</p>
                        </div>
                    </li>
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up" data-aos-delay="100">
                        <div class="media theme-element theme-element--accent">
                        ...
                        <div class="main">
                            <h4 class="main_title">Handover & Check-In</h4>
                            <p class="main_text">Get ready to move in!</p>
                        </div>
                    </li>
                </ul>
            </div>
        ...
        <div class="container d-xl-flex align-items-center justify-content-between">
            <div class="promo_info">
                ...
                <ul class="info_list">
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up">
                        ...
                        <div class="main">
                            <h4 class="main_title">Properties territory</h4>
            ...
            <div class="promo_media" data-aos="fade-up">
                ...
                <div class="media_card media_card--top" data-aos="fade-left">
                    <h4 class="media_card-text">This is the perfect Properties for a weekend getaway!</h4>
    ...
    <div class="container">
        ...
        <div class="gallery_grid d-grid">
            ...
            <div class="gallery_grid-item {{ $index === 0 ? 'gallery_grid-item--left' : ($index === 2 ? 'gallery_grid-item--right' : '') }}" data-aos="zoom-in">
                <a href="{{ asset($image->url ?? asset('img/modal.webp')) }}" data-caption="{{ $image->caption ?? 'Image caption' }}" data-role="gallery-link">
                    <picture>
                        <source data-srcset="{{ asset($image->url ?? asset('img/modal.webp')) }}" srcset="{{ asset($image->url ?? asset('img/modal.webp')) }}" />
                        <img class="gallery_grid-item_img lazy" data-src="{{ asset($image->url ?? asset('img/modal.webp')) }}" src="{{ asset($image->url ?? asset('img/modal.webp')) }}" alt="media" />
                    </picture>
