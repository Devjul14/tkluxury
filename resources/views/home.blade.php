    ...
    <div class="container">
        <div class="rooms_header d-sm-flex justify-content-between align-items-center">
            <h2 class="rooms_header-title" data-aos="fade-right">
                {{ setting('properties_title', 'Properties') }}
            </h2>
    ...
    <div class="container">
        <div class="container d-xl-flex align-items-center justify-content-between">
            <div class="promo_info">
                <h2 class="info_header" data-aos="fade-up">{{ setting('promo_header', 'Stages of booking a property') }}</h2>
                ...
                <ul class="info_list">
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up">
                        ...
                        <div class="main">
                            <h4 class="main_title">{{ setting('online_reservation_title', 'Online reservation') }}</h4>
                            <p class="main_text">{{ setting('online_reservation_text', 'Browse available student accommodations on our platform.') }}</p>
                        </div>
                    </li>
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up" data-aos-delay="50">
                        ...
                        <div class="main">
                            <h4 class="main_title">{{ setting('documents_and_payment_title', 'Documents and payment') }}</h4>
                            <p class="main_text">{{ setting('documents_and_payment_text', 'Fill in your personal data and secure your booking by payment.') }}</p>
                        </div>
                    </li>
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="main">
                            <h4 class="main_title">{{ setting('contract_approval_title', 'Contract Approval') }}</h4>
                            <p class="main_text">{{ setting('contract_approval_text', 'Once payment is successful, a rental agreement will be sent to your email.') }}</p>
                        </div>
                    </li>
                    <li class="list-item d-flex align-items-sm-center" data-aos="fade-up" data-aos-delay="100">
                        {{-- SVG code tetap sama --}}
                        ...
                        <div class="main">
                            <h4 class="main_title">{{ setting('handover_and_checkin_title', 'Handover & Check-In') }}</h4>
                            <p class="main_text">{{ setting('handover_and_checkin_text', 'Get ready to move in!') }}</p>
                        </div>
                    </li>
                </ul>
            </div>
            <div class="promo_media" data-aos="fade-up">
                <picture>
                    <source data-srcset="{{ asset('img/hero.webp') }}" srcset="{{ asset('img/hero.webp') }}" />
                    <img class="lazy" data-src="{{ asset('img/hero.webp') }}" src="{{ asset('img/hero.webp') }}"
                        alt="media" />
                </picture>
            </div>
        </div>
    ...
    <div class="container d-lg-flex">
        ...
        <div class="main col-lg-6 d-lg-flex flex-column justify-content-between">
            <h2 class="reviews_header" data-aos="fade-down">
                {{ setting('reviews_title', 'What our students say') }}
            </h2>
    ...
    <div class="container">
        <div class="gallery_header d-sm-flex justify-content-between align-items-center">
            <h2 class="gallery_header-title">
                {{ setting('gallery_title', 'Photos of our properties') }}
            </h2>
            <div class="wrapper">
        ...
        <div class="contacts_info">
            <div class="contacts_info-header">
                <h2 class="contacts_info-header_title" data-aos="fade-down">
                    <h2 class="contacts_info-header_title" data-aos="fade-down">
                        {{ setting('contacts_header_title', 'Find properties near by institutes') }}
                    </h2>
                </h2>
                <h2 class="contacts_info-header_title" data-aos="fade-down">
                    {{ setting('contacts_header_subtitle', 'Discover student accommodations conveniently located near top universities, colleges, and learning centers. Save time on commuting and focus more on your studies and student life.') }}
                </h2>
            </div>
