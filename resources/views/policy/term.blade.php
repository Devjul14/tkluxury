...
<header class="page">
    <div class="container">
        <div class="page_header">
            <h1 class="page_header-title" data-aos="fade-up">Terms and Condition</h1>
...
<section class="rules section">
    <div class="container">
        <div class="rules_header text-center mb-4">
            <!-- <h2 class="rules_header-title" data-aos="fade-up">House Rules</h2> -->
        ...
        <div class="rules_main">
            <div class="rules_main-grid">
                <div class="rules_main-grid_item mb-4" data-aos="fade-up">
                    <h5 class="rules_main-grid_item-title mb-2">Lorem ipsum dolor sit.</h5>
                    <ul class="rules_main-grid_item-list">
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis magnam, incidunt iste iusto velit voluptate!</li>
